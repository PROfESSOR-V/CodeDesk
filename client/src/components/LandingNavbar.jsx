  ...
  return (
    <nav className="flex items-center justify-between py-4 px-6 bg-white shadow-sm sticky top-0 z-20">
      <div onClick={() => navigate("/")}>
        <BrandName className="text-3xl font-bold cursor-pointer" />
      </div>
      <ul className="hidden md:flex items-center gap-6 text-lg font-medium text-gray-700">
        <li>
      ...
      <button
        ...
        className="ml-auto md:ml-0 bg-[#e67829] text-white px-4 py-2 rounded shadow hover:bg-[#e67829]/90 text-lg"
      >
        Login / Sign Up
      </button>
    </nav>
