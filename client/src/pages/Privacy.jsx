  ...
  return (
    <div className="bg-white text-gray-800 min-h-screen flex flex-col">
      ...
      <div className="max-w-4xl mx-auto py-16 px-6 md:px-20">
        ...
        <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-3">2. How We Use Your Data</h2>
        <p className="mb-4 text-lg text-gray-700">
          We use your data to improve our services, track your progress, and provide personalized experiences.
        </p>

        <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-3">3. Data Security</h2>
        <p className="mb-4 text-lg text-gray-700">
