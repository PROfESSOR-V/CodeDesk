...
const Portfolio = () => {
          ...
          <div className="text-center py-16">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8 max-w-2xl mx-auto">
              {Object.entries(platformIcons).map(([platform, icon]) => (
                <div
                  key={platform}
                  className="flex flex-col items-center p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-blue-300 transition-colors"
                >
 ...
 return (
  ...
  <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-6 transition-colors">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          <ContributionHeatmap 
            ...
            className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 transition-colors"
          />
    ...
    {/* Get Card Modal */}
    {showGetCardModal && <GetCardModal onClose={() => setShowGetCardModal(false)} />}
  </div>
</DashboardLayout>
...
const ProfileCard = ({ user, verifiedPlatforms, onGetCard }) => (
  <div className="bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 transition-colors">
    ...
    <div className="flex justify-center space-x-4 mb-6">
      <a href={`mailto:${user.email}`} className="text-gray-400 hover:text-gray-600 dark:text-gray-300 dark:hover:text-gray-100">
      ...
      {user.linkedinUrl && (
        <a href={user.linkedinUrl} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-400">
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
      ...
      {user.twitterUrl && (
        <a href={user.twitterUrl} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400 dark:text-gray-300 dark:hover:text-blue-300">
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
    ...
    {/* User Info */}
<div className="space-y-2 text-sm text-gray-600 dark:text-gray-300 mb-6 transition-colors">
  {user.country && (
    <div className="flex items-center">
      <svg className="w-4 h-4 mr-2 text-gray-600 dark:text-gray-300 transition-colors" fill="currentColor" viewBox="0 0 20 20">
  ...
  {user.college && (
   ...
   {/* Verified Platforms */}
<div className="mb-6">
  <h4 className="text-sm font-medium text-gray-900 dark:text-gray-200 mb-3 transition-colors">
    Problem Solving Stats
  </h4>
  <div className="text-center p-4 bg-gray-50 dark:bg-gray-800 rounded-md mb-4 transition-colors">
    <div className="text-xs text-gray-500 dark:text-gray-400 mb-1 transition-colors">About</div>
    ...
    {verifiedPlatforms.map((platform) => (
      <div
        ...
        className="flex items-center justify-between py-2 border-b border-gray-200 dark:border-gray-700 last:border-b-0 transition-colors"
      >
        <div className="flex items-center">
          ...
          <span className="text-sm capitalize text-gray-700 dark:text-gray-300 transition-colors">
            {platform.platform}
          </span>
        </div>
        <div className="flex items-center">
...
const TotalQuestionsCard = ({ stats }) => (
  <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 transition-colors">
    <div className="flex items-center justify-between">
      ...
      <div className="w-12 h-12 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center transition-colors">
        <svg
          className="w-6 h-6 text-blue-600 dark:text-blue-300 transition-colors"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
...
const ActiveDaysCard = ({ stats }) => (
  <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 transition-colors">
    <div className="flex items-center justify-between">
      ...
      <div className="w-12 h-12 bg-green-100 dark:bg-green-900 rounded-full flex items-center justify-center transition-colors">
        <svg
          className="w-6 h-6 text-green-600 dark:text-green-300 transition-colors"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
...
const ContestCard = ({ contestData, totalContests }) => (
  <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 transition-colors">
  <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4 transition-colors">Contest Participation</h3>
  <div className="text-center mb-4">
    <p className="text-3xl font-bold text-gray-900 dark:text-white transition-colors">{totalContests}</p>
    <p className="text-sm text-gray-600 dark:text-gray-300 transition-colors">Total Contests</p>
  </div>
...
const RatingCard = ({ stats }) => (
  <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 transition-colors">
    <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4 transition-colors">Total Rating</h3>
    <p className="text-3xl font-bold text-gray-900 dark:text-white transition-colors">{stats.totalRating || 0}</p>
    <p className="text-sm text-gray-600 dark:text-gray-300 transition-colors">Across all platforms</p>
  </div>
);
    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 transition-colors">
      ...
      <div className="flex items-center justify-center">
        <svg width="120" height="120" viewBox="0 0 120 120">
          {/* background circle */}
          <circle cx="60" cy="60" r={radius} fill="none" stroke="#e5e7eb" className="dark:stroke-gray-700" strokeWidth="18" />
          {data.map((d, idx) => {
      ...
      <div className="mt-4 space-y-1 text-sm text-gray-700 dark:text-gray-300 transition-colors">
        {data.map(d => (
  ...
  <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 transition-colors">
    ...
    <div className="space-y-3">
      {contestRatings.map((rating, index) => (
        <div key={index} className="flex items-center justify-between text-gray-700 dark:text-gray-300 transition-colors">
          <div className="flex items-center">
            <img 
    ...
    {awards.length > 0 ? (
      <div className="space-y-2">
        {awards.map((award, index) => (
          <div key={index} className="flex items-center text-gray-700 dark:text-gray-300 transition-colors">
            <img 
            ...
            <span className="text-sm">
              {award.badges.length + award.achievements.length} awards
            </span>
          </div>
        ))}
      </div>
    ) : (
      <p className="text-gray-500 dark:text-gray-400 transition-colors">No awards yet</p>
    )}
  </div>
);
  ...
  <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 transition-colors">
    ...
    <div className="space-y-3">
      {Object.entries(dsaTopics).map(([topic, count], index) => {
        ...
        return (
          <div key={topic} className="flex items-center text-gray-700 dark:text-gray-300 transition-colors">
            <div className="w-24 text-sm truncate">{topic}</div>
            <div className="flex-1 mx-3 bg-gray-200 dark:bg-gray-700 rounded-full h-2 transition-colors">
              <div 
...
const GetCardModal = ({ onClose }) => (
  <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 transition-colors">
    <div className="bg-white dark:bg-gray-800 rounded-lg p-8 max-w-md w-full mx-4 transition-colors">
      <div className="text-center">
        ...
        <button
          onClick={onClose}
          className="bg-blue-600 hover:bg-blue-700 text-white dark:text-white px-6 py-2 rounded-md font-medium transition-colors"
        >
          Close
        </button>
      </div>
