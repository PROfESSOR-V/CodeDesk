...
const ProfileCard = ({ user, verifiedPlatforms, onGetCard }) => (
  <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
    ...
    <button
      onClick={onGetCard}
      className="w-full bg-orange-500 hover:bg-orange-600 dark:bg-orange-600 dark:hover:bg-orange-700 text-white py-3 px-4 rounded-md font-medium mb-6 transition-colors"
    >
      Get Card
    </button>
...
<div className="flex justify-center space-x-4 mb-6">
  ...
  {user.twitterUrl && (
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="text-gray-400 dark:text-gray-400 hover:text-blue-400 dark:hover:text-blue-300"
    >
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
...
<div className="mb-6">
  ...
  <div className="text-center p-4 bg-gray-50 dark:bg-gray-800 rounded-md mb-4">
    <div className="text-xs text-gray-500 dark:text-gray-400 mb-1">About</div>
    <div className="text-xs text-gray-500 dark:text-gray-400 mb-4">Problem Solving Stats ▲</div>
  ...
  <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4">
    <div className="flex items-center justify-between mb-2">
      <div className="text-sm text-gray-700 dark:text-gray-300 font-medium">
        {/* submissions/ streak counters can be inside the SVG html */}
      </div>
      <select 
        value={selectedYear} 
        onChange={(e) => onYearChange(parseInt(e.target.value))}
        className="border border-gray-300 dark:border-gray-600 rounded-md px-2 py-0.5 text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
      >
...
const ContestCard = ({ contestData, totalContests }) => (
  <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
    <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">Contest Participation</h3>
    <div className="text-center mb-4">
      <p className="text-3xl font-bold text-gray-900 dark:text-white">{totalContests}</p>
...
const RatingCard = ({ stats }) => (
  <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
    <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">Total Rating</h3>
    <p className="text-3xl font-bold text-gray-900 dark:text-white">{stats.totalRating || 0}</p>
    <p className="text-sm text-gray-600 dark:text-gray-300">Across all platforms</p>
  </div>
);
  ...
  return (
    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
      ...
      <div className="mt-4 space-y-1 text-sm">
        {data.map(d => (
          <div key={d.label} className="flex items-center justify-between text-gray-700 dark:text-gray-300">
...
const CodeforcesProfileCard = ({ codeforcesData }) => (
  ...
  <div className="space-y-4">
    <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
      <span className="font-medium text-gray-700 dark:text-gray-300">Handle</span>
      <span className="font-bold text-blue-600 dark:text-blue-400">{codeforcesData.handle}</span>
    </div>
    
    <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
      <span className="font-medium text-gray-700 dark:text-gray-300">Current Rating</span>
      <span className="font-bold text-green-600 dark:text-green-400">{codeforcesData.rating || 'Unrated'}</span>
    </div>
    
    <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
      <span className="font-medium text-gray-700 dark:text-gray-300">Max Rating</span>
      <span className="font-bold text-purple-600 dark:text-purple-400">{codeforcesData.max_rating || 'Unrated'}</span>
    </div>
    
    <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
      <span className="font-medium text-gray-700 dark:text-gray-300">Rank</span>
      <span className="font-bold text-orange-600 dark:text-orange-400">{codeforcesData.rank || 'Unrated'}</span>
    </div>
  </div>
...
<div className="space-y-4">
  <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
    <span className="font-medium text-gray-700 dark:text-gray-300">Contribution</span>
    <span className="font-bold text-blue-600 dark:text-blue-400">{codeforcesData.contribution || 0}</span>
  </div>
  
  <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
    <span className="font-medium text-gray-700 dark:text-gray-300">Friends</span>
    <span className="font-bold text-green-600 dark:text-green-400">{codeforcesData.friend_of_count || 0}</span>
  </div>
  
  <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
    <span className="font-medium text-gray-700 dark:text-gray-300">Contests</span>
  ...
  <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
    <span className="font-medium text-gray-700 dark:text-gray-300">Problems Solved</span>
...
{codeforcesData.language_stats && Object.keys(codeforcesData.language_stats).length > 0 && (
  <div className="mt-6">
    <h4 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Programming Languages</h4>
    <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
      {Object.entries(codeforcesData.language_stats)
        .sort(([,a], [,b]) => b - a)
        .slice(0, 6)
        .map(([language, count]) => (
          <div key={language} className="bg-blue-50 dark:bg-blue-900 p-3 rounded-lg text-center">
            <div className="font-bold text-blue-600 dark:text-blue-400">{count}</div>
...
{codeforcesData.tag_stats && Object.keys(codeforcesData.tag_stats).length > 0 && (
  <div className="mt-6">
    <h4 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Problem Categories</h4>
    <div className="flex flex-wrap gap-2">
      {Object.entries(codeforcesData.tag_stats)
        ...
        .map(([tag, count]) => (
          <span 
            key={tag} 
            className="bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-400 px-3 py-1 rounded-full text-sm font-medium"
          >
            {tag} ({count})
          </span>
        ))
