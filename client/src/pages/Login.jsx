    ...
    try {
      ...
      if (user) {
        try {
          ...
          if (!res.ok) console.warn("/api/users/sync returned", res.status);
        } catch (syncErr) {
    ...
    <div className="min-h-screen flex flex-col lg:flex-row bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div ref={formRef} className="w-full max-w-md space-y-6">
          ...
          <p className="text-xs text-center text-gray-400 dark:text-gray-500">
            By signing in or creating an account, you agree to our <span className="text-[#e67829]">Terms &amp; Conditions</span> and <span className="text-[#e67829]">Privacy Policy</span>.
          </p>
        </div>
      </div>
      ...
      <div className="hidden lg:flex flex-1 bg-[#e67829] text-white px-12 py-16 flex-col justify-center gap-12">
        <h2 className="text-4xl font-extrabold leading-tight mb-6">
          Welcome to <BrandName className="inline" variant="white" />
        </h2>
